...
with st.sidebar:
    selection = option_menu('Lung Cancer Prediction System',
    ['Introduction',
    'About the Dataset',
...
if (selection == 'About the Dataset'):
    ...
    tab1, tab2, tab3 , tab4= st.tabs(["Dataset analysis", "Training Data", "Test Data","Algorithms Used"])
...
if (selection == 'Lung Cancer Prediction'):
    ...
    if st.button('Lung Cancer Test Result'):
        ...
        if (heart_prediction[0] == 'High'):
          heart_diagnosis = 'The person is having, or may have Lung Cancer.'
          ...
          heart_diagnosis = 'The person does not have any Lung Cancer.'
          st.balloons()
